...
const BOT_KNOWLEDGE = {
  "🛠️ Core Skills": {
    reply: "I specialize in Hardware Engineering: Altium PCB design, STM32 bare-metal C/C++, SOLIDWORKS CAD, and autonomous robotics (ArduPilot/ROS).",
    nextChips: ["🛩️ SN-21 VTOL Project", "⚡ View PCB Experience", "📩 Contact Info"]
  },
  "🛩️ SN-21 VTOL Project": {
  ...
  "👓 Drishti Smart Glass": {
    reply: "Drishti is a wearable smart glass prototype featuring micro-camera assembly, flexible circuit routing, and custom CAD enclosure design.",
    nextChips: ["🛠️ Core Skills", "💼 Hiring / Freelance", "📩 Contact Info"]
  },
  "⚡ View PCB Experience": {
    ...
    nextChips: ["🛩️ SN-21 VTOL Project", "💼 Hiring / Freelance"]
  },
  "🏆 WRO Competitions": {
    ...
    nextChips: ["🛠️ Core Skills", "📩 Contact Info"]
  },
  "💼 Hiring / Freelance": {
  ...
  "📧 Email Directly": {
    reply: "Direct email address: noman1272003@gmail.com. Feel free to send over project details or job descriptions!",
    nextChips: ["🛠️ Core Skills", "🛩️ SN-21 VTOL Project"]
  }
};
...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState([
    { sender: "bot", text: "Hi! I'm Noman's assistant. What would you like to explore today?" }
  ]);
  ...
  const handleSelectOption = (questionText) => {
    if (questionText === "📩 Send Message") {
      ...
      setMessages((prev) => [
        ...
        { sender: "bot", text: "Please enter your email below and Noman will get back to you directly:" }
      ]);
      return;
    }
    ...
    setTimeout(() => {
      const data = BOT_KNOWLEDGE[questionText] || {
        reply: "Thanks for asking! For specific technical details, feel free to send a message using the Contact section below.",
  ...
  const handleEmailSubmit = (e) => {
    ...
    setMessages((prev) => [
      ...
      { sender: "bot", text: "Got it! Thanks for leaving your details. Noman will respond to your email shortly." }
    ]);
    setUserEmail("");
  ...
  return (
    <div className="chatbot-wrapper">
      <button className="chat-trigger-btn" onClick={toggleChat} aria-label="Toggle Chat Assistant">
      ...
      {isOpen && (
        <div className="chat-window">
          <div className="chat-header">
            ...
            <div>
              <h3>Noman's Assistant</h3>
              <span className="online-indicator"><span className="dot"></span> Active</span>
            </div>
          ...
          <div className="chat-footer">
            {showContactInput ? (
              ...
              <>
                <p className="chip-label">Suggested Topics:</p>
